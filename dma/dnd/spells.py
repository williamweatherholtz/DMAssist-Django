...
class Spell():
    ...
    def __str__(self):
        ...
        if self.role == 'M':
            ...
            spell_class = 'Magic-User/Illusionist'
...
cleric_spells = [
    ...
    Spell('Ceremony','C',1,
        ...
        duration=tp(1,P),
        range='Touch',
        aoe='One creature, one item, or area (see below)',
        save='Special',
        sourcebook=U,
    ...
    Spell('Portent','C',1,
        ...
        duration=tp(1,VA),
        range='Touch',
        aoe='Spell caster or figure touched',
        save='None',
        sourcebook=U,
    ...
    Spell('Precipitation','C',1,
        ...
        duration_lvl=tp(1,S),
        range='1"/level',
        aoe='3" diameter cylinder up to 12" high',
        save='None',
        sourcebook=U,
    ...
    Spell('Purify Food & Drink','C',1,
        ...
        duration=tp(1,P),
        range='3"',
        aoe='1 cubic foot/level, 1" square area',
        save='None',
        sourcebook=V,
    ...
    Spell('Cloudburst','C',3,
        ...
        duration=tp(1,R),
        range='1"/level',
        aoe='3" diam. cylinder up to 6" high',
        save='None (& special)',
        sourcebook=U,
    ...
    Spell('Negative Plane Protection','C',3,
        ...
        duration_lvl=tp(1,T),
        range='Touch',
        aoe='One Prime Material Plane creature',
        save='None',
        sourcebook=U,
    ...
    Spell('Remove Paralysis','C',3,
        ...
        duration_lvl=tp(0),
        range='1"/level',
        aoe='1-4 creatures in a 2" x 2" area',
        save='None',
        sourcebook=U,
    ...
    Spell('Neutralize Poison','C',4,
        ...
        duration=tp(1,P),
        range='Touch',
        aoe='Creature touched or 1 cubic foot of substance/2 levels',
        save='None',
        sourcebook=V,
    ...
    Spell('Spike Growth','C',4,
        ...
        duration_lvl=tp(1,T),
        range='6"',
        aoe='10\' square per level of caster',
        save='None',
        sourcebook=U,
    ...
    Spell('Flame Strike','C',5,
        ...
        duration=tp(1,S),
        range='6"',
        aoe='1" diameter by 3" high column',
        save='½',
        sourcebook=V,
    ...
    Spell('Spike Stones','C',5,
        ...
        duration_lvl=tp(1,T),
        range='3"',
        aoe='1" square per level, 1 spike per 1\' sq.',
        save='None',
        sourcebook=U,
    ...
    Spell('Heroes\' Feast','C',6,
        ...
        duration=tp(1,H),
        range='1"',
        aoe='One individual per level of caster',
        save='None',
        sourcebook=U,
...
druid_spells = [
    ...
    Spell('Detect Balance','D',1,
        ...
        duration_lvl=tp(1,R),
        range='6"',
        aoe='One object or creature per round',
        save='None',
        sourcebook=U,
    ...
    Spell('Precipitation','D',1,
        ...
        duration_lvl=tp(1,S),
        range='1"/level',
        aoe='3" diam. cylinder up to 12" high',
        save='None (& special)',
        sourcebook=U,
    ...
    Spell('Pyrotechnics','D',3,
        ...
        duration=tp(1,VA),
        range='16"',
        aoe='10 or 100 times the fire source',
        save='None',
        sourcebook=V,
    ...
    Spell('Stone Shape','D',3,
        ...
        duration=tp(1,P),
        range='Touch',
        aoe='Three cubic feet, plus one cubic foot per level',
        save='None',
        sourcebook=V,
    ...
    Spell('Repel Insects','D',4,
        ...
        duration_lvl=tp(1,T),
        range='0',
        aoe='10\' radius of the spell caster',
        save='None',
        sourcebook=V,
    ...
    Spell('Moonbeam','D',5,
        ...
        duration_lvl=tp(1,R),
        range='1"/level',
        aoe='1" diameter sphere (plus special)',
        save='None',
        sourcebook=U,
...
mu_spells = [
    ...
    Spell('Clean','M',0,
        ...
        save = 'None',
        sourcebook = U,
        desc = 'This cantrip enables the caster to remove heavy soil, dirt, and like foreign objects from floors, walls, dishes, windows, etc. The subject surfaces are then spotless, but care must be taken in removal of pigments and the like, so usually only one type of material will be treated in a single application. Verbal component is a low outrush of air, somatic is a circular hand motion.'
    ),
    Spell('Color','M',0,
        cast = tp(5,DS),
        duration = tp(30,D),
    ...
    Spell('Dampen','M',0,
        ...
        save = 'None',
        sourcebook = U,
        desc = 'When a cantrip of this sort is cast, the subject area is permeated by a fog-like dampness which leaves all material within it damp to the touch. It is useful for many sorts of things. It is hard on parchment, and it similarly makes it and like substances hard to set aflame. Those within the area of effect of the <i>dampen</i> cantrip will be enwrapped in a light fog, and objects in this fog, while still visible, will lose their detail. Verbal component is a low hooting or a hummed ditty, somatic is a hand gesture upwards with writhing fingers.'
    ),
    Spell('Dry','M',0,
        cast = tp(5,DS),
        duration = tp(0),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'This cantrip removes dampness and excess moisture from materials within the area of effect. It is useful for cloth, herbs, and cleaning chores. Verbal component is similar to that of the <a href="/spells/dampen-magicillusionist-lvl-0><i>dampen</i></a> cantrip, and the somatic is a two-handed wringing motion.'
    ),
    Spell('Dust','M',0,
        cast = tp(5,DS),
        duration = tp(0),
    ...
    Spell('Flavor','M',0,
        ...
        save = 'None',
        sourcebook = U,
        desc = 'This cantrip enables the caster to give the subject a superior or better or different flavor. Thus, mush can be made to taste as if it were lobster bisque, but the dweomer will not actually affect quality or wholesomeness. Spoiled food remains spoiled; a poisoned drink would still be deadly (though any tell-tale taste of the poison may be masked in this fashion). The verbal component is a muttered lip-smacking sound; the somatic gesture is a shaking motion.'
    ),
    Spell('Freshen','M',0,
        cast = tp(5,DS),
        duration = tp(1,H),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'By means of this cantrip, the caster bring new life or freshness to the object desired. The magic applies to food and drink items such as milk, beer, meat, and raw vegetables. It also works with cut vegetables, flowers, herbs, etc. Although it will remove a slight taint of spoilage, restore drooping flowers, and so on, it is not as effective as a <a href="/spells/purify-food-drink-cleric-lvl-1/"><i>purify food & drink</i></a> spell, and it lasts for but an hour. The subject must be of relatively small size, i.e. a small cask of liquid, a sheep, a bushel of vegetables, etc. If used on a creature that is harmed by magics such as <i>purify food & drink</i>, the cantrips inflicts 1-4 points of damage. The verbal component is an <i>mmmmmm</i> sound, while the hand makes a mystic symbol with thumb and forefinger forming a circle and the other fingers upright and apart.'
    ),
    Spell('Gather','M',0,
        cast = tp(2,DS),
        duration = tp(0),
    ...
    Spell('Polish','M',0,
        ...
        save = 'None',
        sourcebook = U,
        desc = 'When this cantrip is used, the caster magically smooths and brings a luster to materials such as wood, metal, stone, leather, or ceramic. Naturally, the desired object must be relatively clean in order for the cantrip to be effective. The object affected must be of reasonable size - a floor of up to 1,000 square feet, an armoire, etc. It works better on smaller objects, of course, such as boots, mirrors, crystal containers, etc. The caster hums a ditty while making a buffing motion.'
    ),
    Spell('Salt','M',0,
        cast = tp(2,DS),
        duration = tp(0),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'This cantrip causes a sprinkling of fine salt to magically appear and descend upon the desired object - a stew, some troublesome weed patch, or a barrel of stock fish to be preserved. The object must be of reasonable size - up to perhaps 4 square yards in area or about 30 gallons liquid volume. Care must be taken to avoid over-salting if the object involved is smaller, and if the object is larger, it will not receive much salt. Creatures adversely affected by salt (such as a <a href="/creatures/giant-slug">giant slug</a>) take 1-4 points of damage from this cantrip. The verbal component is a labial smacking, performed while the hand makes a sprinkling motion.'
    ),
    Spell('Shine','M',0,
        cast = tp(5,DS),
        duration = tp(0),
        ...
        save = 'None',
        sourcebook = U,
        desc = ('Similar to the <a href="/spells/polish-magic-user-lvl-0"><i>polish</i></a> cantrip, this magic allows the caster to remove tarnish, rust, corrosion, and similar substances from the desired object. This cantrip brings about a mirror-bright shine to objects capable of such, causing their surfaces to be smooth and unmarred. A piece of jewelry, for instance, would be made more attractive, and the gems (only) of such a piece might be actually made more valuable: If base value of the gem(s) in a piece of jewelry was originally decreased, and a <i>shine</i> cantrip is used upon the object, then the owner may (if desired) find out whether the value of the gem(s) has been changed. (The DM should roll again on the "Increase or Decrease of Worth Beyond Base Value" table on page 26 of the DMG, with a -1 modifier to the die roll.) No gem can be "re-valued" in this manner more than once.\n\n'
            'A single object up to about 1 cubic yard in volume can be treated by this cantrip. Its components are similar to those of <i>polish</i>.'
        )
    ),
    Spell('Spice','M',0,
        cast = tp(5,DS),
    ...
    Spell('Stitch','M',0,
        ...
        save = 'None',
        sourcebook = U,
        desc = 'This cantrip magically sews seams in cloth or leather. It will make new ones, or repair old work. About 20 yards of cloth can be thus stitched, but only about 2 yards of leather. The seam thus created is neither stronger nor weaker than a seam done without magic. Usually a brief rhyme is recited as the hand makes a sewing motion.'
    ),
    Spell('Sweeten','M',0,
        cast = tp(5,DS),
        duration = tp(0),
        ...
        aoe = 'One object',
        sourcebook = U,
        desc = 'This cantrip is the same as a <a href="/spells/spice-magic-user-lvl-0"><i>spice</i></a> cantrip, except that the result is the evocation of a sweetener - sugar, honey, or even a syrup. Components are a buzzing sound and a stirring motion.'
    ),
    Spell('Tie','M',0,
        cast = tp(5,DS),
        duration = tp(0),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'By means of this cantrip, the caster can magically cause the object of the magic - thread, string, cord, rope, or even cable - to tightly knot itself to either its other end or an end of a similar object within 1\' of it. The resulting know will be a normal one such as a square knot, half-hitch, running bowline, or whatever other sort is desired. The caster verbalizes the name of the knot while holding up three fingers.'
    ),
    Spell('Warm','M',0,
        cast = tp(5,DS),
        duration = tp(0),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'This cantrip is the same as <a href="/spells/chill-magic-user-lvl-0"><i>chill</i></a>, except that the magic brings a warming of the liquid or solid. The temperature will rise at most about 40° F. The cantrip will never cause living creatures to become warmer than their normal body temperature. Components are an <i>aah</i> sound vocalized while the hands are rubbed briskly together.'
    ),
    Spell('Wrap','M',0,
        cast = tp(5,DS),
        duration = tp(0),
    ...
    Spell('Curdle','M',0,
        ...
        aoe = 'One object',
        sourcebook = U,
        desc = 'This cantrip is broader than its name, for it affects many food and drink items. The magic curdles milk and hastens spoilage or wilting, but does not <a href="/spells/purify-food-drink-cleric-lvl-1/"><i>putrefy food & drink</i></a> as per that spell. It has a permanent effect on the object. It is otherwise similar to <a href="/spells/freshen-magic-user-lvl-0"><i>freshen</i></a>. The caster verbalizes a retching sound while pointing the thumb downward.'
    ),
    Spell('Dirty','M',0,
        cast = tp(2,DS),
        duration = tp(0),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'The opposite of a <a href="/spells/clean-magic-user-lvl-0"><i>clean</i></a> cantrip, this enables the caster to soil, spot, and sully walls, floors, dishes, garments, etc. Verbal component is a spitting sound, made while the feet are shuffled and stamped.'
    ),
    Spell('Dusty','M',0,
        cast = tp(2,DS),
        duration = tp(0),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'By means of this cantrip, the caster causes a film of dust and grime to settle upon all exposed surfaces within the cantrip area of effect. The verbal component is a low humming sound, made while the hands move in shaking motions.'
    ),
    Spell('Hairy','M',0,
        cast = tp(1,DS),
        duration = tp(0),
    ...
    Spell('Knot','M',0,
        ...
        save = 'None',
        sourcebook = U,
        desc = 'This cantrip is a permutation of the <a href="/spells/tie-magic-user-lvl-0"><i>tie</i></a> cantrip. It causes the thread, string, cord, or rope to know itself in such a manner as to be very difficult to untie, and from 2-8 rounds, minus dexterity bonus for reaction of the individual untrying the <i>knot</i>, to undo. It works even on material already affected by a <i>tie</i> cantrip, but not on magical ropes, ropes being held onto by a character or creature, or taut lines such as a bowstring. The caster verbalizes a low <i>zzzz</i> sound while moving the arm forward with a strong wrist motion.'
    ),
    Spell('Ravel','M',0,
        cast = tp(1,DS),
        duration = tp(0),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'This cantrip is the reverse of <a href="/spells/stitch-magic-user-lvl-0"><i>stitch</i></a>. It will work only if there is a loose or broken thread in the seam or fabric to be affected, except for material magically stitched by the appropriate cantrip. When the latter sort of seam or material is involved, the <i>ravel</i> cantrip will always work except in a case where the subject is otherwise magical, i.e. a <i>bag of holding</i>, a <i>cloak of protection</i>, <i>boots of elvenkind</i>, etc. The name of the cantrip is verbalized while the fingers make a plucking motion.'
    ),
    Spell('Sour','M',0,
        cast = tp(5,DS),
        duration = tp(0),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'When this cantrip is used, the caster causes the subject food or drink to take on a sour taste, not unlike vinegar of the appropriate sort. While it is typically used to spoil wine, beer, or some pastry, the <i>sour</i> cantrip can be used to useful purpose. The magic actually causes about a pint (maximum) of vinegar to appear over the subject. This can be an empty container in which such liquid is desired. The caster purses the lips and makes a <i>whoosh</i> sound while clenching the hand.'
    ),
    Spell('Spill','M',0,
        cast = tp(2,DS),
        duration = tp(0),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'The opposite of a <a href="/spells/gather-magic-user-lvl-0"><i>gather</i></a> cantrip, this enables the caster to cause the contents of a container to spill out. The object container is actually tipped by the cantrip, and since the magic is not powerful, containers of more than about gallon size, or magical ones, will not be affected by the cantrip. Solids and/or liquids within the object container will spill out, if the container is not securely closed or capped. To bring about the magic, the caster verbalizes and <i>uh-oh</i> sound while making an abrupt hand motion.'
    ),
    Spell('Tangle','M',0,
        cast = tp(2,DS),
        duration = tp(0),
    ...
    Spell('Tarnish','M',0,
        ...
        save = 'None',
        sourcebook = U,
        desc = 'The reverse of a <a href="/spells/shine-magic-user-lvl-0"><i>shine</i></a> cantrip, this causes a covering of rust, corrosion, verdigris, or the like to cover an object normally subject to such tarnishing. The object must be of about 1 cubic yard or less in volume. Verbal component is a spitting sound, while the hand makes a sprinkling motion.'
    ),
    Spell('Untie','M',0,
        cast = tp(3,DS),
        duration = tp(0),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'This permutation of a <a href="/spells/tie-magic-user-lvl-0"><i>tie</i></a> cantrip is simlpy the reverse of the magic. The caster selects an object - thread, string, cord, etc. - which is knotted or tied. The cantrip removes the <i>knot</i> or tying. Note that the <i>untie</i> cantrip will cause a <a href="/spells/tangle-magic-user-lvl-0"><i>tangle</i></a> to be nullified. The cantrip will not remove both a <i>knot</i> and a normal tying (normal know or one caused by a <i>tie</i> cantrip), but it will cause the former to disappear so that only a normal tying remains. This cantrip has no effect on magical objects. Somatic and verbal components vary according to the desired result. In general, a popping sound is made while the hands are moved apart - either as if a knot were being untied or a cord snapped.'
    ),
    Spell('Wilt','M',0,
        cast = tp(5,DS),
        duration = tp(0),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'A reverse of the <a href="/spells/freshen-magic-user-lvl-0"><i>freshen</i></a> cantrip which affects only vegetable material - whether growing or picked. Thus, a plant can be made to wilt (or possibly wither if it is not very healthy), or a bunch of cut flowers sag or droop. Verbal component is a descending hum, while the forefinger is slowly curled from an upright position.'
    ),
    Spell('Change','M',0,
        cast = tp(1,DS),
        duration = tp(1,VA),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'By means of a <i>change</i> cantrip, the caster alters one small object to another, although the change must be within the same kingdom, and only animal and vegetable objects are affected. Thus, a piece of parchment can be changed to a brightly colored cloth square, then the cloth can be changed to a rose by another use of the cantrip. Likewise, a bird can be changed into a bat, the bat to a flying squirrel by another use of the same cantrip, and so forth. Each change requires a <i>change</i> cantrip. The cantrip will not cause more than a 50% increase or decrease in size/volume, and the effect will last for a base time of 1 turn. If the <i>change</i> is radical, then the time will be reduced accordingly; i.e. changing a dead object to a live one is a radical change and will last only 1 round. On the other hand, a very slight alteration such as color change or the like will last for 1 or more days. A saving throw aginst this magic does not apply as long as small animal-intelligence, non-magical creatures of normal sort are concerned. Typically, a magic word is verbalized while the hand makes a pass over the object to be affected.'
    ),
    Spell('Distract','M',0,
        cast = tp(3,DS),
        duration = tp(1,S),
    ...
    Spell('Mute','M',0,
        ...
        save = 'Neg.',
        sourcebook = U,
        desc = 'The <i>mute</i> cantrip allows the caster to alter the shape of small objects of a mineral nature. The magic is effective against glass, metal, stone, etc. A plane can be altered to a rod, a torus to a sphere, etc. Thus, a coin could be changed to a ring. Similarly, glass could be changed to crystal, lead to silver, copper to gold, etc. However, the dweomers of magical items are too strong for this cantrip to affect them. The duration of the <i>mute</i> is but 1 round. If another individual actually touches the object affected, the dweomer of the cantrip might be affected: The individual touching it makes a saving throw versus spell, and if it succeeds the cantrip is dispelled. The components for the <i>mute</i> cantrip are similar to those of a <a href="/spells/change-magic-user-lvl-0"><i>change</i></a> cantrip.'
    ),
    Spell('Palm','M',0,
        cast = tp(1,DS),
        duration = tp(0),
    ...
    Spell('Belch','M',0,
        ...
        save = 'Lower volume',
        sourcebook = U,
        desc = 'When this cantrip is cast, the subject will involuntarily belch. A saving throw is applicable only to see how loud of muffled the burping is, failure indicating a very loud belch, success meaning that the sound is relatively low and muffled. The verbal component is an almost inaudible belch, done at the same time that the caster\'s hand presses his or her diaphragm.'
    ),
    Spell('Blink','M',0,
        cast = tp(1,DS),
        duration = tp(1,DS),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'By means of this cantrip, the caster causes the subject person (or creature) to blink his, her, or its eye or eyes. The blinking reaction is only momentary, of course, lasting no more than half a second. A successful saving throw indicates only a single eye wink, or no effect for one-eyed creatures. The verbal component is a softly spoken magical word (such as <i>hat-cha-cha</i>), voiced while the caster snaps his fingers.'
    ),
    Spell('Cough','M',0,
        cast = tp(3,DS),
        duration = tp(1,VA),
        ...
        save = 'Reduce effect',
        sourcebook = U,
        desc = 'This cantrip enables the caster to make the subject individual cough spasmodically. If a saving throw is made, the cough is only a brief hacking which will not usually disturb other activities. Failing the saving throw indicates the victim is affected by a loud and active series of coughs lasting from 1 to 3 seconds. The somatic component is a gagging gesture while a gasp is verbalized.'
    ),
    Spell('Giggle','M',0,
        cast = tp(3,DS),
        duration = tp(5,DS),
        ...
        save = 'Reduce effect',
        sourcebook = U,
        desc = 'By means of this cantrip, the caster causes the subject individual to involuntarily giggle. The loudness and length of this reaction depend on the saving throw. If the subject fails to save, the result will be a chuckle or giggle lasting about 2 or 3 seconds. If the save succeeds, only a brief chuckle will be caused. The verbal component is a single word or phrase (known in magical circles as a "punch line") to be spoken while one finger is moved back and forth rapidly.'
    ),
    Spell('Nod','M',0,
        cast = tp(1,DS),
        duration = tp(0),
    ...
    Spell('Sneeze','M',0,
        ...
        save = 'Neg.',
        sourcebook = U,
        desc = 'A cantrip of this nature causes an irritation in the nasal passages of the subject. Unless the subject makes a successful saving throw versus spell, a sneeze will occur. This single sneeze will relieve the irritation. The caster verbalizes the name of an irritant substance while touching his or her nose.'
    ),
    Spell('Twitch','M',0,
        cast = tp(2,DS),
        duration = tp(0),
    ...
    Spell('Wink','M',0,
        ...
        save = 'Reduce effect',
        sourcebook = U,
        desc = 'This cantrip enables the caster to cause the subject individual to wink one eye. A saving throw indicates that the winking is rapid and not greatly noticeable, while failure to save indicates a greatly exaggerated, prolonged winking. The caster speaks a magical phrase (such as <i>twenty-three skidoo</i>) while making an imperceptible winking out of his or her eye.'
    ),
    Spell('Yawn','M',0,
        cast = tp(2,DS),
        duration = tp(1,R),
        ...
        save = 'Neg.',
        sourcebook = U,
        desc = 'A <i>yawn</i> cantrip makes the subject creature feel a brief wave of drowsiness which in turn evokes a yawn reaction. If a saving throw versus spell succeeds, the subject creature is totally unaffected by the dweomer of the cantrip. Failure, however, not only forces a yawn to immediately occur, but the subject is then more susceptible to a <a href="/spells/sleep-magic-user-lvl-1"><i>sleep</i></a> spell. During the balance of the round in which the <i>yawn</i> cantrip was cast, and during the whole of the following round, the subject will automatically fall into comatose slumber from a <i>sleep</i> spell cast upon it, so 1 additional creature will be vulnerable to the spell if more than 1 creature of 4 or fewer hit dice are subjected to the spell. Further, if creatures of 4 + 1 to 4 + 4 hit dice are involved, there is then a chance that two such creatures will actually be affected by <i>sleep</i>. Even a creature of up to 5 + 2 hit dice can be affected by <i>sleep</i> if previously victimized by a <i>yawn</i> cantrip, but the effect of the <i>sleep</i> spell is rolled for as if the creature had 4 + 1 to 4 + 4 hit dice; i.e., there is a 50% chance that it will not be affected. The caster hums a lullaby for the verbal component while making a rocking motion with cupped hands.'
    ),
    Spell('Bee','M',0,
        cast = tp(5,DS),
        duration = tp(1,P),
    ...
    Spell('Bluelight','M',0,
        ...
        save = 'None',
        sourcebook = U,
        desc = 'This cantrip enables the caster to conjure a small sphere of glowing blue radiance. The light has an eerie effect when seen from a distance, but the 3-inch sphere only illuminates an area of 5\' around itself. Furthermore, the <i>bluelight</i> does not cast reflections beyond this radius. The light does not affect either infravision or ultravision. When the caster says a rhyme using the words <i>blue</i> and <i>light</i> in any combination, the <i>bluelight</i> appears in his or her open palm and remains aglow until the caster ceases to concentrate on it.'
    ),
    Spell('Bug','M',0,
        cast = tp(5,DS),
        duration = tp(0),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'A variation of the <a href="/spells/bee-magic-user-lvl-0"><i>bee</i></a> cantrip, the <i>bug</i> cantrip enables the caster to summon some form of crawling insect. The beetle or bug appears in the same manner as the bee summoned by the cantrip of that name. It will likewise be irritated and will pinch, bite, or otherwise attack the creature it finds itself upon, with appropriate results. Verbal component is the name of the insect desired while the caster\'s forefinger makes a sliding and pointing motion at the desired area of the bug\'s appearance (up to 1" distant).'
    ),
    Spell('Firefinger','M',0,
        cast = tp(3,DS),
        duration = tp(1,S),
        range = '1"',
        aoe = '½\' line',
        save = 'None',
        sourcebook = U,
        desc = 'The <i>firefinger</i> cantrip enables the caster to cause a jet of flame up to one-half foot in length to shoot forth from his or her finger. The flame is very hot and will ignite combustible materials such as parchment, twigs, kindling, and the like without difficulty, providing the materials are relatively dry. The flame persists for up to 1 segment. To bring about the magic of this cantrip, the caster speaks a word of power over elemental fire (such as <i>ron-son</i>, <i>zip-po</i>, or the much revered word, <i>dun-hill</i>), extends the forefinger, and makes a sideways motion with the thumb.'
    ),
    Spell('Gnats','M',0,
        cast = tp(5,DS),
        duration = tp(0),
        ...
        save = 'Neg.',
        sourcebook = U,
        desc = 'A cantrip of this nature is similar to the <a href="/spells/bee-magic-user-lvl-0"><i>bee</i></a> and <a href="bug-magic-user-lvl-0"><i>bug</i></a> cantrips, except that when it is used a cloud of gnats is summoned. The swarm will immediately proceed to fly around the head of the nearest living creature (which must be no more than 1" from the caster), and unless this creature makes a successful saving throw versus poison, the cloud of gnats will distract the creature for from 1-4 segments before the gnats fly elsewhere. The verbal component is a high-pitched buzzing sound made with the tongue and upper palate while the caster points a digit at the area in which the gnat cloud is to appear.'
    ),
    Spell('Mouse','M',0,
        cast = tp(5,DS),
        duration = tp(0),
    ...
    Spell('Tweak','M',0,
        ...
        aoe = 'One creature',
        sourcebook = U,
        desc = 'By means of this cantrip, the caster causes an unseen thumb and forefinger to harmlessly, but annoyingly, tweak some portion of a chosen subject within a 1" radius of the caster. Portions subject to the <i>tweak</i> cantrip are: cheek, nose, ear, beard, moustache, whiskers, or tail. The cantrip\'s effects do not disturb spell casting, although the tweaking might distract any creature by causing it to turn to discover the source of the annoyance. A failure to save versus spell (with respect to creatures with an intelligence under 7), or failure to roll a score greater than intelligence on 3d6 (with respect to creatures with intelligence of 7 or greater), indicates a 1-segment distraction. The caster speaks a magic phrase (such as <i>kitchy-kitchy-coo</i>) while making a pinching and pulling motion with thumb and forefinger.'
    ),
    Spell('Unlock','M',0,
        cast = tp(5,DS),
        duration = tp(0),
        ...
        aoe = 'One lock',
        sourcebook = U,
        desc = 'This cantrip enables the caster to conjure an invisible, key-like force appropriate to the locking mechanism to be opened (or closed). The <i>unlock</i> cantrip will affect only simple locks of the most basic sort - typically those which have closing pressure prongs or bolts and pins, or bolt and spring closures. Locks with tumblers or levers, as well as secret-combination locks, are not subject to this cantrip. Note that simple locks with complex wards to prevent skeleton-key triggering will be subject to an <i>unlock</i> cantrip. While the caster speaks a word or phrase associated with lock (<i>tick-tock-doublelock</i> or <i>yah-el</i>, etc.) he or she makes a twisting motion with fingers held as if to grasp a key.'
    ),
    ...
    Spell('Firewater','M',1,
        ...
        duration=tp(1,R),
        range='1"',
        aoe='1 pint of water per level of caster',
        save='None',
        sourcebook=U,
    ...
    Spell('Friends','M',1,
        ...
        duration_lvl=tp(1,R),
        range='0',
        aoe='1" + 1"/level of spell caster radius sphere',
        save='Special',
        sourcebook=V,
    ...
    Spell('Grease','M',1,
        ...
        duration=tp(1,P),
        range='1"',
        aoe='1 sq. ft. per level of caster',
        save='',
        sourcebook=U,
    ...
    Spell('Magic Missile','M',1,
        ...
        duration=tp(0),
        range='6" + 1"/level',
        aoe='One or more creatures in a 10 square foot area',
        save='None',
        sourcebook=V,
    ...
    Spell('Melt','M',1,
        ...
        duration_lvl=tp(1,R),
        range='3"',
        aoe='1 cu. yd. of ice or 2 cu. yds. of snow per level of caster',
        save='Special',
        sourcebook=U,
    ...
    Spell('Run','M',1,
        ...
        duration=tp(1,VA),
        range='Touch',
        aoe='Special (humans, demi-humans only)',
        save='None',
        sourcebook=U,
    ...
    Spell('Taunt','M',1,
        ...
        duration=tp(0),
        range='3"',
        aoe='2 levels or hit dice per level of caster',
        save='',
        sourcebook=U,
    ...
    Spell('Fools Gold','M',2,
        ...
        duration_lvl=tp(6,T),
        range='1"',
        aoe='1 cubic foot per level of the magic-user',
        save='None',
        sourcebook=V,
    ...
    Spell('Zephyr','M',2,
        ...
        duration=tp(1,S),
        range='0',
        aoe='1" path, ½" per level in length',
        save='None',
        sourcebook=U,
    ...
    Spell('Detect Illusion','M',3,
        ...
        duration_lvl=tp(1,R),
        range='Touch',
        aoe='Line of sight 1" wide, 1"/level long',
        save='None',
    ...
    Spell('Haste','M',3,
        ...
        duration_lvl=tp(1,R),
        range='6"',
        aoe='4" x 4" area, 1 creature/level',
        save='',
        sourcebook=V,
    ...
    Spell('Item','M',3,
        ...
        duration_lvl=tp(6,T),
        range='Touch',
        aoe='2 cu. ft. per level of caster',
        save='Special',

        sourcebook=U,
        desc=("Duration quadrupled if used on non-living material.\n\n"
    ...
    Spell('Material','M',3,
        ...
        duration=tp(1,P),
        range='1"',
        aoe='1 cu. ft. per level of caster',
        save='None',
        sourcebook=U,
    ...
    Spell('Secret Page','M',3,
        ...
        duration=tp(1,P),
        range='Touch',
        aoe='One page of any size up to 2 ft. square',
        save='None',
        sourcebook=U,
    ...
    Spell('Wind Wall','M',3,
        ...
        duration_lvl=tp(1,R),
        range='1"/level',
        aoe='An area 1" wide and ½" high per level of caster',
        save='Special',
        sourcebook=U,
    ...
    Spell('Evard\'s Black Tentacles','M',4,
        ...
        duration=tp(1,R),
        range='3"',
        aoe='30 sq. ft. per level of caster',
        save='None',
        sourcebook=U,
    ...
    Spell('Fear','M',4,
        ...
        duration_lvl=tp(1,R),
        range='0',
        aoe='6" long cone, 3" diameter at end, ½\' at base',
        save='Neg.',
        sourcebook=V,
    ...
    Spell('Otiluke\'s Resilient Sphere','M',4,
        ...
        duration_lvl=tp(1,R),
        range='2"',
        aoe='1 ft. diameter sphere per level of caster',
        save='Neg.',
        sourcebook=U,
    ...
    Spell('Airy Water','M',5,
        ...
        duration_lvl=tp(1,T),
        range='0',
        aoe='2" diameter sphere or 4" diameter hemisphere',
        save='',
        sourcebook=V,
    ...
    Spell('Fabricate','M',5,
        ...
        duration=tp(1,P),
        range='½"/level',
        aoe='1 cu. yd. per level of caster',
        save='None',
        sourcebook=U,
    ...
    Spell('Hold Monster','M',5,
        ...
        duration_lvl=tp(1,R),
        range='½"/level',
        aoe='One to four monsters (creatures)',
        save='Neg.',
        sourcebook=V,
    ...
    Spell('Leomund\'s Lamentable Belabourment','M',5,
        ...
        duration=tp(1,VA),
        range='1"',
        aoe='One or more creatures in a 1" radius',
        save='Special',
        sourcebook=U,
    ...
    Spell('Leomund\'s Secret Chest','M',5,
        ...
        duration=tp(60,D),
        range='Special',
        aoe='One chest of about 2\'x2\'x3\' size',
        save='None',
        sourcebook=V,
    ...
    Spell('Guards and Wards','M',6,
        ...
        duration_lvl=tp(6,T),
        range='0',
        aoe='1" radius/level, extending from 2" diameter sphere',
        save='None',
        sourcebook=V,
    ...
    Spell('Transmute Water To Dust','M',6,
        ...
        duration=tp(1,P),
        range='6"',
        aoe='1 cubic " per level of caster',
        save='None (& special)',
        sourcebook=U,
    ...
    Spell('Banishment','M',7,
        ...
        duration=tp(1,P),
        range='2"',
        aoe='2 levels/HD of creature(s) per level of caster',
        save='Special',
        sourcebook=U,
    ...
    Spell('Mordenkainen\'s Magnificent Mansion','M',7,
        ...
        duration_lvl=tp(1,H),
        range='1"',
        aoe='300 sq. ft. per level of caster',
        save='',
        sourcebook=U,
    ...
    Spell('Sequester','M',7,
        ...
        duration_lvl=tp(1,D),
        range='Touch',
        aoe='2\' cube per level of caster',
        save='Special',
        sourcebook=U,
    ...
    Spell('Otiluke\'s Telekinetic Sphere','M',8,
        ...
        duration_lvl=tp(1,R),
        range='2"',
        aoe='1\' diameter sphere per level of caster',
        save='Neg.',
        sourcebook=U,
    ...
    Spell('Sink','M',8,
        ...
        duration=tp(1,VA),
        range='1"/level',
        aoe='One creature or one object of 1 cu. " per level of caster',
        save='',
        sourcebook=U,
...
illusionist_spells = [
    Spell('Creak','I',0,
        ...
        save = 'None',
        sourcebook = U,
        desc = 'By means of this cantrip, the caster evokes a noise similar to that of a door with corroded hinges slowly opening, or else a sound as if someone or something were walking across squeaking floorboards. The former sound lasts for one-third segment; the latter noise will last half a segment and seem to traverse up to 10 feet distance. The caster makes a low creaking sound in his or her throat while using a hand to make an opening motion or fingers to make a walking motion.'
    ),
    Spell('Footfall','I',0,
        cast = tp(2,DS),
        duration = tp(0),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'When this cantrip is used, the caster creates the audial illusion of footsteps. The sound is as if a human or humanoid was walking. The footfalls can be soft or fairly noisy. They can approach, move away from, follow, or otherwise seem to parallel a person or party. They must begin within 1" of the caster, but they may thereafter move away from him or her up to a 2" distance, or may approach closer than 1". The caster must softly vocalize sounds similar to footsteps while pointing in the area they are to occur initially and subsequently.'
    ),
    Spell('Groan','I',0,
        cast = tp(2,DS),
        duration = tp(0),
    ...
    Spell('Moan','I',0,
        ...
        save = 'None',
        sourcebook = U,
        desc = 'This cantrip is the same as a <a href="/spells/groan-illusionist-lvl-0"><i>groan</i></a> cantrip, except that the sound involved is either a pitiful moaning or else an eerie one. The desired sound is either a low-pitched one for the haunting effect or a high-pitched one for the pitiful effect.'
    ),
    Spell('Rattle','I',0,
        cast = tp(1,DS),
        duration = tp(3,DS),
        ...
        save = 'None',
        sourcebook = U,
        desc = 'By means of this cantrip, the caster causes the audible illusion of a rattling sound associated with chains. Its direction and distance is the same as for a <a href="/spells/groan-illusionist-lvl-0"><i>groan</i></a> cantrip. The sound will last for up to 2 seconds. All creatures within 1" of the sound are entitled to a saving throw versus spell to determine whether they hear the illusory sound. The spell caster names the rattling device which he or she desires to create the illusion of while shaking one hand vigorously.'
    ),
    Spell('Tap','I',0,
        cast = tp(2,DS),
        duration = tp(0),
    ...
    Spell('Spook','I',1,
        ...
        duration=tp(1,VA),
        range='0',
        aoe='One creature within 1" of the illusionist',
        save='Neg.',
        sourcebook=U,
    ...
    Spell('Hallucinatory Terrain','I',3,
        ...
        duration=tp(1,VA),
        range='2" + 2"/level',
        aoe='4" x 4" square area + 1" x 1" square area/level',
        save='None',
        sourcebook=V,
    ...
    Spell('Solid Fog','I',4,
        ...
        duration_lvl=tp(1,R),
        range='3"',
        aoe='2 cubic " per level of caster',
        save='None',
        sourcebook=U,
    ...
    Spell('Vacancy','I',4,
        ...
        duration_lvl=tp(1,T),
        range='1"/level',
        aoe='1" radius per level of caster',
        save='None',
        sourcebook=U,
    ...
    Spell('Advanced Illusion','I',5,
        ...
        duration_lvl=tp(1,R),
        range='6" + 1"/level',
        aoe='4 square " + 1 square " per level',
        save='Special',
        sourcebook=U,
    ...
    Spell('Phantasmagoria','I',6,
        ...
        duration_lvl=tp(1,R),
        range='6"',
        aoe='4 square " + 1 square " per level of caster',
        save='',
        sourcebook=U,
    ...
    Spell('Prismatic Spray','I',7,
        ...
        duration=tp(0),
        range='0',
        aoe='7" long plane, 1½" wide at end, ½" wide at base',
        save='Special',
        sourcebook=V,
